...
## Notes
- Standups should be posted on the day that you make the post on Discord. (i.e. Some standups posted on Discord with a February timestamp were for January 29). Otherwise this defeats the purpose of the standup.
- Missing PR for GD-7 (Not tracked on Jira)
- Collaborators should be other cards that the card is collaborating with rather than the actual library