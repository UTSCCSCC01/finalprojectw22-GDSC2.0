...
UI looks very similar to the old website, talk to product leads and make sure they're okay with that.

Login form and admin page looks a little different from the theme of the rest of the site. 

It's ambigious on first glance what the progress bar on the student Mentor app UI page is meant to represent.
...
1/2 should include more documentation for frontend and backend systems — maybe look into something like Swagger.ui? Alternatively, it'd also be fine to have a word doc specifically for documentation, separate from the system design doc. 
