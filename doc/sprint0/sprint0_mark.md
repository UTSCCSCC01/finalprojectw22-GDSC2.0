...
**Team Name:** GDSC2.0 
**Github:** https://github.com/UTSCCSCC01/finalprojectw22-GDSC2.0
...
## Process: process.md (max 10 marks)
  - Team organization (roles) divided clearly (max 2 marks)
    ...
    Your mark: 1 - roles not assigned
...
## User experience: (max 4 marks)
  ...
  - Graphic representation is clear and represents well indended user interface elements (max 2 marks)
    ...
    Your mark: 1 - purpose of some components isn't very clear; could be explained more or made a bit more clear
