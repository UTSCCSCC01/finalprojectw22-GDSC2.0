                        ...
                        bugs.map((bug, index) =>
                            <tr key={bug._id}>
                                ...
                                <td className="edit-delete">
                                    <FontAwesomeIcon className="edit" icon={faEdit} onClick={(e) => showModal(e, bug)}></FontAwesomeIcon>
                                    <FontAwesomeIcon className="delete" icon={faTrash} onClick={(e) => handleDeleteListener(e, bug._id)}></FontAwesomeIcon>
                                </td>
                            </tr>
                        )
                    }
